...
def test_top_level_package_keeps_internal_helpers_out_of_star_imports() -> None:
    namespace: dict[str, object] = {}
    exec("from delivery_flow import *", {}, namespace)
    assert "build_normalized_review_snapshot" not in namespace
    assert "build_terminal_summary_snapshot" not in namespace
