...
- install the shared skills as direct entries under `~/.agents/skills/`
- expect `delivery-flow/SKILL.md`, `using-delivery-flow/SKILL.md`, and `implementation-review/SKILL.md` to exist as direct skill entries
